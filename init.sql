...
-- 시나리오용 고정 계정 생성
-- 관리자 계정 생성
INSERT INTO USERS (ID, USERNAME, PASSWORD, ROLE, BUSINESS_TOKEN, CREATED_AT) 
VALUES (1, 'admin', '85f455ba36624ed0f6a0751189f8e2b1', 'ADMIN', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', SYSTIMESTAMP);

-- 기업 회원 계정 생성
INSERT INTO USERS (ID, USERNAME, PASSWORD, ROLE, BUSINESS_TOKEN, CREATED_AT) 
VALUES (2, 'bob_edu', 'bed128365216c019988915ed3add75fb', 'BUSINESS', 'e5f6a7b8-c9d0-1234-5678-9abcdef01234', SYSTIMESTAMP);
